...
| As a general and returning visitor, I want to quickly find contact details. | 1. From any page on the site, scroll to the bottom.2. Locate the contact information section and the social media links. | The contact information is easily visible in the footer. Social media links are present and correctly linked. | Pass ![alt text](assets/images/testing/footer.png "Footer") |
...
![alt text](assets/images/testing/jshintscript.png "Results from https://jshint.com/")
